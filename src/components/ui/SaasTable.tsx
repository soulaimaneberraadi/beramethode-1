...
export default function SaasTable<T extends Record<string, any>>({
  ...
  return (
    <div className="w-full">
        ...
        <div className="mb-3">
          <div className="relative max-w-xs">
            ...
            <input
              ...
              className="
                w-full h-8 pl-8 pr-8 text-[12px] text-slate-700
      ...
      <div
        className={`
          w-full border border-slate-200 rounded-lg overflow-hidden
        ...
        <table className="w-full border-collapse">
          ...
          <thead className="bg-slate-50/60 sticky top-0 z-10">
            <tr className="border-b border-slate-100">
              ...
              {showRowNumbers && (
                <th className="w-10 px-3 py-2.5 text-[10px] font-medium text-slate-400 uppercase tracking-wide text-center">
                  #
                </th>
              )}
              {columns.map((col) => (
                <th
                  key={col.key}
                  className={`
                    px-4 py-2.5 text-[11px] font-medium text-slate-500 uppercase tracking-wide
              ...
              sorted.map((row, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {showRowNumbers && (
                      <td className="w-10 px-3 py-2.5 text-[11px] text-slate-400 text-center tabular-nums">
                        {idx + 1}
                      </td>
                    )}
                    {columns.map((col) => (
