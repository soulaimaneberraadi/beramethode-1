                        ...
                        <div className="px-4 sm:px-5 h-12 border-b border-slate-100 flex items-center justify-between shrink-0">
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <div className="min-w-0">
                                    <h3 className="text-[13px] font-semibold text-slate-900 tracking-tight">{tx(lang, {fr:'Factures', ar:'الفواتير', en:'Invoices', es:'Facturas', pt:'Faturas', tr:'Faturalar'})}</h3>
                        ...
                        <div className="p-3 sm:p-5 overflow-y-auto">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                                ...
                                >
                                    ...
                                    <span className="text-[10px] text-slate-400">{tx(lang, {fr:'Fichier local', ar:'ملف محلي', en:'Local file', es:'Archivo local', pt:'Arquivo local', tr:'Yerel dosya'})}</span>
                                </button>
                            ...
                            {loading ? (
                                ...
                                <div className="py-6 text-center text-[12px] text-slate-400">{tx(lang, {fr:'Aucune facture pour cette matière.', ar:'لا توجد فواتير لهذه المادة.', en:'No invoices for this material.', es:'No hay facturas para este material.', pt:'Nenhuma fatura para este material.', tr:'Bu malzeme için fatura yok.'})}</div>
                            ) : (
                                        ...
                                        return (
                                            <div key={it.id} className="group relative rounded-lg border border-slate-100 overflow-hidden bg-white">
                                                ...
                                                <div className="px-2 py-1.5 flex items-center justify-between gap-1 border-t border-slate-100">
                                                    ...
                                                    <button onClick={() => del(it.id)} className="shrink-0 p-1 rounded text-slate-400 hover:text-rose-600 hover:bg-rose-50 transition-colors" title={tx(lang, {fr:'Supprimer', ar:'حذف', en:'Delete', es:'Eliminar', pt:'Excluir', tr:'Sil'})}>
