...
export default function LaCoupe({ models, setModels, onOpenInAtelier, currentModelId, setFicheData }: LaCoupeProps) {
    ...
    const STATUS_MAP = {
        ...
        'EN_COURS': { label: tx(lang, { fr: 'En Cours', ar: 'قيد التنفيذ', en: 'In Progress', es: 'En Curso', pt: 'Em Andamento', tr: 'Devam Ediyor' }), color: 'text-blue-700 dark:text-blue-300 border-blue-400 dark:border-blue-600', icon: PlayCircle },
        'SOUS_TRAITANCE': { label: tx(lang, { fr: 'Extériorisé', ar: 'مقاول خارجي', en: 'Subcontracted', es: 'Subcontratado', pt: 'Terceirizado', tr: 'Taşeron' }), color: 'text-purple-700 dark:text-purple-300 border-purple-400 dark:border-purple-600', icon: Truck },
        'VALIDE': { label: tx(lang, { fr: 'Validé', ar: 'تم التحقق', en: 'Validated', es: 'Validado', pt: 'Validado', tr: 'Onaylandı' }), color: 'text-emerald-700 dark:text-emerald-300 border-emerald-400 dark:border-emerald-600', icon: CheckCircle },
