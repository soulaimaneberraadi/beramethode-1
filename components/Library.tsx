    ...
    return (
        <div className="h-full overflow-y-auto bg-slate-50/50 dark:bg-dk-bg/50 custom-scrollbar flex flex-col">
            <div className="p-4 pb-2 shrink-0">
                <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-3 bg-white dark:bg-dk-surface p-3 rounded-2xl border border-slate-200 dark:border-dk-border shadow-sm dark:shadow-dk-elevated">
                    ...
                    <div className="flex flex-wrap gap-2 w-full xl:w-auto items-center">
                        <button onClick={onCreateNewProject} className="flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold text-xs shadow-md shadow-emerald-200 dark:shadow-dk-elevated transition-all active:scale-95">
                ...
                {filteredModels.length > 0 ? (
                                    ...
                                    >
                                        <div className="aspect-[4/3] bg-slate-50 dark:bg-dk-bg border-b border-slate-100 dark:border-dk-border flex items-center justify-center group-hover:bg-indigo-50 dark:bg-dk-accent/20/20 dark:group-hover:bg-dk-elevated/20 transition-colors relative overflow-hidden">
                                            ...
                                            {model.meta_data.category && (
                                                <div className="absolute bottom-2 left-2 bg-black/60 dark:bg-black/80 backdrop-blur-md text-white px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wide flex items-center gap-1 shadow-sm max-w-[90%]">
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-slate-400 dark:text-dk-muted min-h-[400px] border-2 border-dashed border-slate-200 dark:border-dk-border rounded-3xl bg-slate-50/50 dark:bg-dk-bg/50">
                        ...
                        <div className="flex gap-3">
                            <button onClick={onCreateNewProject} className="px-4 py-2 bg-emerald-600 text-white hover:bg-emerald-700 rounded-lg text-sm font-bold shadow-md dark:shadow-dk-elevated transition-colors flex items-center gap-2">
            ...
            {contextMenu && createPortal(
                <div
                    className="fixed bg-white dark:bg-dk-surface rounded-xl shadow-2xl dark:shadow-dk-elevated border border-slate-100 dark:border-dk-border w-56 z-[9999] py-1.5 animate-in fade-in zoom-in-95 duration-100 origin-top-left overflow-hidden"
                    ...
                    <div className="bg-white dark:bg-dk-surface rounded-2xl shadow-2xl dark:shadow-dk-elevated w-full max-w-sm overflow-hidden p-6 text-center transform scale-100 transition-all">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 px-4 py-2.5 bg-rose-600 text-white hover:bg-rose-700 rounded-xl font-bold text-sm shadow-lg shadow-rose-200 dark:shadow-dk-elevated transition-colors"
                            >
