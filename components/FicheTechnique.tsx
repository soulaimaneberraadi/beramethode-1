                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                        <div className="bg-emerald-50/50 px-4 sm:px-6 py-3 border-b border-emerald-100 flex items-center gap-2">
                            ...
                            <h3 className="font-bold text-emerald-800 text-sm uppercase tracking-wide">
                                {tx(lang, {
                                    fr: 'Données Techniques & Production',
                                    ar: 'البيانات التقنية والإنتاج',
                                    en: 'Technical & Production Data',
                                    es: 'Datos técnicos y de producción',
                                    pt: 'Dados técnicos e de produção',
                                    tr: 'Teknik ve Üretim Verileri'
                                })}
                            </h3>
                        </div>
                        <div className="p-4 sm:p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                ...
                                <div className="space-y-1 relative group">
                                    <div className="flex justify-between">
                                        <label className="text-xs font-bold text-slate-400 uppercase ml-1">
                                            {tx(lang, {
                                                fr: "Temps de l'article (Min)",
                                                ar: "وقت القطعة (Min)",
                                                en: "Article time (Min)",
                                                es: "Tiempo del artículo (Min)",
                                                pt: "Tempo do artigo (Min)",
                                                tr: "Ürün süresi (Min)"
                                            })}
                                        </label>
                                    ...
                                    <div className="absolute top-full left-0 w-full text-[10px] text-slate-400 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        {tx(lang, {
                                            fr: "Calculé depuis la gamme",
                                            ar: "محسوب من تسلسل العمليات",
                                            en: "Calculated from routing",
                                            es: "Calculado desde la gama",
                                            pt: "Calculado a partir da gama",
                                            tr: "Rotalama üzerinden hesaplandı"
                                        })} ({totalTime.toFixed(2)} + {tx(lang, {
                                            fr: "Majoration",
                                            ar: "زيادة",
                                            en: "Allowance",
                                            es: "Incremento",
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-bold text-slate-400 uppercase ml-1">
                                        {tx(lang, {
                                            fr: "Nombre d'ouvriers",
                                            ar: "عدد العمال",
                                            en: "Number of workers",
                                            es: "Número de obreros",
                                            pt: "Número de operários",
                                            tr: "İşçi sayısı"
                                        })}
                                    </label>
                                ...
                                {/* Input: Chaine */}
                                <div className="space-y-1">
                                    <label className="text-xs font-bold text-slate-400 uppercase ml-1">{pt.chaineLabel}</label>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                        <div className="bg-indigo-50/50 px-4 sm:px-6 py-3 border-b border-indigo-100 flex items-center gap-2">
                            ...
                            <h3 className="font-bold text-indigo-800 text-sm uppercase tracking-wide">
                                {tx(lang, {
                                    fr: "Contrôles de Planification & Risques",
                                    ar: "مراقبة التخطيط والمخاطر",
                                    en: "Planning & Risk Controls",
                                    es: "Controles de planificación y riesgos",
                                    pt: "Controlos de planeamento e riscos",
                                    tr: "Planlama ve Risk Kontrolleri"
                                })}
                            </h3>
                        </div>
                        <div className="p-4 sm:p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center">
                                        <label className="text-xs font-bold text-slate-400 uppercase ml-1">
                                            {tx(lang, {
                                                fr: "Facteur de Planning",
                                                ar: "عامل التخطيط",
                                                en: "Planning Factor",
                                                es: "Factor de planificación",
                                                pt: "Fator de planeamento",
                                                tr: "Planlama Faktörü"
                                            })}
                                        </label>
                                    ...
                                    <p className="text-[10px] text-slate-400 leading-tight">
                                        {tx(lang, {
                                            fr: "Coefficient d'ajustement de la performance pour le calcul des dates de fin (Default: 60%).",
                                            ar: "معامل تعديل الأداء لحساب تواريخ الانتهاء (افتراضي: 60%).",
                                            en: "Performance adjustment coefficient for calculating end dates (Default: 60%).",
                                            es: "Coeficiente de ajuste de rendimiento para calcular las fechas de finalización (Predeterminado: 60%).",
                                            pt: "Coeficiente de ajuste do desempenho para o cálculo das datas de fim (Predefinido: 60%).",
                                            tr: "Bitiş tarihlerinin hesaplanması için performance düzeltme katsayısı (Varsayılan: %60)."
                                        })}
                                    </p>
                                </div>
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-bold text-slate-400 uppercase ml-1">
                                        {tx(lang, {
                                            fr: "Buffer de Lancement (min)",
                                            ar: "مهلة الإطلاق (min)",
                                            en: "Launch Buffer (min)",
                                            es: "Búfer de lanzamiento (min)",
                                            pt: "Buffer de lançamento (min)",
                                            tr: "Başlatma Tamponu (min)"
                                        })}
                                    </label>
                                    ...
                                    <p className="text-[10px] text-slate-400 leading-tight">
                                        {tx(lang, {
                                            fr: "Temps nécessaire à la préparation des machines avant production (Default: 120 min / 2h).",
                                            ar: "الوقت اللازم لإعداد الآلات قبل الإنتاج (افتراضي: 120 min / 2h).",
                                            en: "Time required to prepare machines before production (Default: 120 min / 2h).",
                                            es: "Tiempo necesario para preparar las máquinas antes de la producción (Predeterminado: 120 min / 2h).",
                                            pt: "Tempo necessário para a preparação das máquinas antes da produção (Predefinido: 120 min / 2h).",
                                            tr: "Üretim öncesinde makinelerin hazırlanması için gereken süre (Varsayılan: 120 min / 2h)."
                                        })}
                                    </p>
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-[10px] text-slate-400 leading-tight">
                                        {tx(lang, {
                                            fr: "Configure les règles de planification, de transit et de coûts.",
                                            ar: "يضبط قواعد التخطيط والعبور والتكاليف.",
                                            en: "Configures planning, transit, and cost rules.",
                                            es: "Configura las reglas de planificación, tránsito y costes.",
                                            pt: "Configura as regras de planeamento, trânsito e custos.",
                                            tr: "Planlama, transit ve maliyet kurallarını yapılandırır."
                                        })}
                                    </p>
                                </div>
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs font-bold text-slate-400 uppercase ml-1">
                                        {tx(lang, {
                                            fr: "Statut Production",
                                            ar: "حالة الإنتاج",
                                            en: "Production Status",
                                            es: "Estado de producción",
                                            pt: "Estado da produção",
                                            tr: "Üretim Durumu"
                                        })}
                                    </label>
                                    <FancySelect
                                    ...
                                    <p className="text-[10px] text-slate-400 leading-tight">
                                        {tx(lang, {
                                            fr: "Statut opérationnel du modèle dans l'atelier.",
                                            ar: "الحالة التشغيلية للموديل في الورشة.",
                                            en: "Operational status of the model in the workshop.",
                                            es: "Estado operativo del modelo en el taller.",
                                            pt: "Estado operacional do modelo na oficina.",
                                            tr: "Atölyedeki modelin operasyonel durumu."
                                        })}
                                    </p>
                                    {statutSyncMsg && (
                            ...
                            <div className="mt-6 pt-4 border-t border-slate-100">
                                {data.typeMarche === 'Export' ? (
                                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="text-xs font-bold text-blue-800 uppercase tracking-wide font-sans">
                                                {tx(lang, {
                                                    fr: "Règles Spéciales Export (Europe)",
                                                    ar: "قواعد خاصة بالتصدير (أوروبا)",
                                                    en: "Special Export Rules (Europe)",
                                                    es: "Reglas especiales de exportación (Europa)",
                                                    pt: "Regras especiais de exportação (Europa)",
                                                    tr: "Özel İhracat Kuralları (Avrupa)"
                                                })}
                                            </h4>
                                            <p className="text-[11px] text-blue-600 mt-1 leading-normal font-sans">
                                                {tx(lang, {
                                                    ...
                                                    ar: "- يتم تلقائيًا خصم ",
                                                    en: "- A ",
                                                    es: "- Se deduce automáticamente un ",
                                                    pt: "- Um ",
                                                    tr: "- Gümrük ve paketleme için planlamadaki DDS'den otomatik olarak 3 günlük bir "
                                                })}
                                                <strong>
                                                     {tx(lang, {
                                                         fr: "Buffer de Transit de 3 jours",
                                                         ar: "مهلة عبور مدتها 3 أيام",
                                                         en: "3-day Transit Buffer",
                                                         es: "búfer de tránsito de 3 días",
                                                         pt: "Buffer de trânsito de 3 dias",
                                                         tr: "Transit Tamponu"
                                                     })}
                                                </strong>
                                                {tx(lang, {
                                                     fr: " est automatiquement déduit du DDS dans le planning pour la douane et l'emballage.",
                                                     ar: " من DDS في التخطيط للجمارك والتعبئة.",
                                                     en: " is automatically deducted from DDS in the planning for customs and packaging.",
                                                     es: " de DDS en la planificación para la aduana y el embalaje.",
                                                     pt: " é deduzido automaticamente do DDS no planeamento para a alfândega e embalagem.",
                                                     tr: " düşülür."
                                                })}
                                                <br />
                                                {tx(lang, {
                                                     fr: "- L'analyse des coûts (Revenant) se concentre sur la ",
                                                     ar: "- يركز تحليل التكاليف (سعر التكلفة) على ",
                                                     en: "- Cost analysis focuses on ",
                                                     es: "- El análisis de costes se centra únicamente en la ",
                                                     pt: "- A análise de custos foca-se apenas na ",
                                                     tr: "- Maliyet analizi yalnızca "
                                                })}
                                                <strong>
                                                     {tx(lang, {
                                                         fr: "Main d'œuvre",
                                                ...
                                                {tx(lang, {
                                                     fr: " uniquement (Matières fournies par le client).",
                                                     ar: " فقط (المواد المقدمة من العميل).",
                                                     en: " only (Materials supplied by the customer).",
                                                     es: " (Materiales proporcionados por el cliente).",
                                                     pt: " (Matérias fornecidas pelo cliente).",
                                                     tr: " üzerine odaklanır (Malzemeler müşteri tarafından sağlanır)."
                                                })}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="text-xs font-bold text-emerald-800 uppercase tracking-wide font-sans">
                                                {tx(lang, {
                                                    fr: "Règles Spéciales Marché Local",
                                                    ar: "قواعد خاصة بالسوق المحلي",
                                                    en: "Special Local Market Rules",
                                                    es: "Reglas especiales de mercado local",
                                                    pt: "Regras especiais de mercado local",
                                                    tr: "Özel Yerel Pazar Kuralları"
                                                })}
                                            </h4>
                                            <p className="text-[11px] text-emerald-600 mt-1 leading-normal font-sans">
                                                ...
                                                <strong>
                                                     {tx(lang, {
                                                         fr: "BOM (Matrice de matières)",
                                                         ar: "BOM (جدول المواد)",
                                                         en: "BOM (Bill of Materials)",
                                                         es: "BOM (matriz de materias)",
                                                         pt: "BOM (matriz de matérias)",
                                                         tr: "BOM (Malzeme Listesi)"
                                                     })}
                                                </strong>
                                                {tx(lang, {
                                                     fr: " et l'évaluation du stock magasin sont obligatoires.",
                                                     ar: " وتقييم مخزون المستودع إلزاميان.",
                                                     en: " and store stock evaluation are mandatory.",
                                                     es: " y la evaluación del stock de almacén son obligatorias.",
                                                     pt: " e a avaliação do stock do armazém são obrigatórias.",
                                                     tr: " ve mağaza stok değerlendirmesi zorunludur."
                                                })}
                                                <br />
                                                {tx(lang, {
                                                     fr: "- Toute pénurie de matière bloquera automatiquement l'ordre de fabrication (Statut: ",
                                                     ar: "- أي نقص في المواد سيؤدي تلقائيًا إلى حظر أمر التصنيع (الحالة: ",
                                                     en: "- Any material shortage will automatically block the production order (Status: ",
                                                     es: "- Cualquier escasez de material bloqueará automáticamente la orden de fabricación (Estado: ",
                                                     pt: "- Qualquer escassez de material bloqueará automaticamente a ordem de fabrico (Estado: ",
                                                     tr: "- Herhangi bir malzeme eksikliği, başlatmadan önce üretim emrini otomatik olarak engelleyecektir (Durum: "
                                                 })}
                                                <strong>BLOCKED_STOCK</strong>
                                                {tx(lang, {
                                                     fr: ") avant le lancement.",
                                                     ar: ") قبل الإطلاق.",
                                                     en: ") before launch.",
                                                     es: ") antes del lanzamiento.",
                                                     pt: ") antes do lançamento.",
                                                     tr: ")."
                                                 })}
                                            </p>
                                        </div>
                ...
                <div className="md:col-span-4 space-y-6 order-1 md:order-2 md:sticky md:top-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
                            ...
                            <div className="absolute top-2 left-2 z-10 flex items-center gap-1.5 rounded-full bg-white/90 backdrop-blur-sm border border-slate-200/80 px-2 py-1 shadow-sm">
                                <span className="text-[9px] font-black tracking-widest text-slate-600 uppercase">
                                    {tx(lang, { fr: 'Devant', ar: 'أمام', en: 'Front', es: 'Frente', pt: 'Frente', tr: 'Ön' })}
                                </span>
                            </div>
                            {/* Upload button */}
                            <button
                            ...
                            <div
                                ...
                                onClick={() => {
                                    if (images.front) setPreviewImage({
                                        src: images.front,
                                        title: tx(lang, { fr: 'Devant', ar: 'أمام', en: 'Front', es: 'Frente', pt: 'Frente', tr: 'Ön' })
                                    });
                                ...
                                {isProcessingImg === 'front' ? (
                                    <div className="flex flex-col items-center gap-2 text-indigo-500">
                                        ...
                                        <span className="text-[9px] font-bold uppercase tracking-wider">
                                            {tx(lang, { fr: 'Compression...', ar: 'ضغط...', en: 'Compressing...', es: 'Comprimiendo...', pt: 'A comprimir...', tr: 'Sıkıştırılıyor...' })}
                                        </span>
                                    </div>
                                ) : images.front ? (
                                    <>
                                    ...
                                    <div className="flex flex-col items-center justify-center gap-2 text-slate-400 p-4">
                                        ...
                                        <span className="text-[10px] font-semibold text-slate-400">
                                            {tx(lang, { fr: 'Ajouter photo', ar: 'إضافة صورة', en: 'Add photo', es: 'Añadir foto', pt: 'Adicionar foto', tr: 'Fotoğraf ekle' })}
                                        </span>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
                            ...
                            <div className="absolute top-2 left-2 z-10 flex items-center gap-1.5 rounded-full bg-white/90 backdrop-blur-sm border border-slate-200/80 px-2 py-1 shadow-sm">
                                <span className="text-[9px] font-black tracking-widest text-slate-600 uppercase">
                                    {tx(lang, { fr: 'Dos', ar: 'ظهر', en: 'Back', es: 'Espalda', pt: 'Costas', tr: 'Arka' })}
                                </span>
                            </div>
                            {/* Upload button */}
                            <button
                            ...
                            <div
                                className="aspect-[3/4] w-full bg-gradient-to-br from-slate-100 to-slate-50 relative cursor-pointer overflow-hidden flex items-center justify-center"
                                onClick={() => {
                                    if (images.back) setPreviewImage({
                                        src: images.back,
                                        title: tx(lang, { fr: 'Dos', ar: 'ظهر', en: 'Back', es: 'Espalda', pt: 'Costas', tr: 'Arka' })
                                    });
                            ...
                            >
                                ...
                                {isProcessingImg === 'back' ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center gap-2 text-slate-400 p-4">
                                        ...
                                        <span className="text-[10px] font-semibold text-slate-400">
                                            {tx(lang, { fr: 'Ajouter photo', ar: 'إضافة صورة', en: 'Add photo', es: 'Añadir photo', pt: 'Adicionar foto', tr: 'Fotoğraf ekle' })}
                                        </span>
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 flex items-center justify-between gap-4 font-sans">
                        <div>
                            <div className="text-xs font-bold text-slate-500 uppercase">
                                {tx(lang, {
                                    fr: "Mode Préparation / Montage",
                                    ar: "وضع التحضير / التركيب",
                                    en: "Preparation / Assembly Mode",
                                    es: "Modo de preparación / montaje",
                                    pt: "Modo de preparação / montagem",
                                    tr: "Hazırlık / Montaj Modu"
                                })}
                            </div>
                            {data.sectionSplitEnabled && (
                                <div className="text-[11px] text-slate-500 mt-1">
                                    {tx(lang, {
                                        fr: "Séparation active: flux, effectifs, dates et rendement distincts.",
                                        ar: "الفصل نشط: تدفق، عمالة، تواريخ وإنتاجية منفصلة.",
                                        en: "Active separation: distinct flow, workforce, dates, and yield.",
                                        es: "Separación activa: flujo, personal, fechas y rendimiento distintos.",
                                        pt: "Separação ativa: fluxo, pessoal, datas e rendimento distintos.",
                                        tr: "Aktif ayırma: belirgin akış, iş gücü, tarihler ve verim."
                                    })}
                                </div>
                            )}
                        </div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 flex flex-col font-sans">
                        <label className="text-xs font-bold text-slate-500 uppercase mb-2">
                            {tx(lang, {
                                fr: "Observations (Echantillon)",
                                ar: "ملاحظات (العينة)",
                                en: "Observations (Sample)",
                                es: "Observaciones (Muestra)",
                                pt: "Observações (Amostra)",
                                tr: "Gözlemler (Numune)"
                            })}
                        </label>
                        <textarea
                            ...
                            placeholder={tx(lang, {
                                fr: "Remarques techniques, défauts tissu, instructions spéciales...",
                                ar: "ملاحظات تقنية، عيوب القماش، تعليمات خاصة...",
                                en: "Technical remarks, fabric defects, special instructions...",
                                es: "Observaciones técnicas, defectos del tejido, instrucciones especiales...",
                                pt: "Observações técnicas, defeitos do tecido, instruções especiais...",
                                tr: "Teknik açıklamalar, kumaş hataları, özel talimatlar..."
                            })}
                        />
                    </div>
                ...
                >
                    ...
                    >
                        <div className="flex items-center justify-between border-b border-slate-200 bg-gradient-to-r from-slate-50 via-white to-slate-50 px-4 py-3 sm:px-5">
                            <div className="min-w-0">
                                ...
                                <p className="text-[11px] font-semibold uppercase tracking-wider text-slate-400">
                                    {tx(lang, {
                                        fr: "Aperçu haute résolution",
                                        ar: "معاينة بدقة عالية",
                                        en: "High resolution preview",
                                        es: "Vista previa en alta resolución",
                                        pt: "Visualização em alta résolution",
                                        tr: "Yüksek çözünürlüklü önizleme"
                                    })}
                                </p>
                            </div>
                            <button
                        ...
                        <div className="border-t border-slate-200 bg-white px-4 py-2 text-center text-[11px] font-medium text-slate-500 sm:px-5">
                            {tx(lang, {
                                fr: "Cliquer en dehors ou appuyer sur ",
                                ar: "انقر بالخارج أو اضغط على ",
                                en: "Click outside or press ",
                                es: "Haga clic fuera o presione ",
                                pt: "Clique fora ou prima ",
                                tr: "Dışarıya tıklayın veya "
                            })}
                            <span className="font-bold text-slate-700">Esc</span>
                            {tx(lang, {
                                fr: " pour fermer",
                                ar: " للإغلاق",
                                en: " to close",
