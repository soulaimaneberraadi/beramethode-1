    ...
    return (
        <div className="shrink-0 border-b border-red-100 dark:border-red-900/30 bg-red-50 dark:bg-red-900/20 dark:bg-red-900/10">
            <button
                ...
                className="w-full h-10 px-3 sm:px-6 flex items-center justify-between gap-3 hover:bg-red-50/40 dark:hover:bg-red-900/20 transition-colors"
            >
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[12px] font-semibold text-red-900 dark:text-red-400 tracking-wide uppercase">
                    ...
                    <div className="h-4 w-px bg-red-200 dark:bg-red-800/50" />
                ...
                <ChevronDown
                    className={`w-4 h-4 text-red-700 dark:text-red-400 transition-transform ${expanded ? 'rotate-180' : ''}`}
                    strokeWidth={2.5}
                />
            </button>

            {expanded && (
                <div className="max-h-[380px] overflow-y-auto border-t border-red-100 dark:border-red-900/30 divide-y divide-red-100/60 dark:divide-red-900/20 bg-white dark:bg-dk-surface">
                    {crisisEvents.map(ev => {
                        ...
                        return (
                            <div key={ev.id} className="p-3 sm:p-4 transition-colors hover:bg-slate-50/40 dark:hover:bg-dk-elevated/40">
                                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 sm:gap-4">
                                    <div className="min-w-0 flex-1">
                                        <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            <h4 className="text-[12px] font-bold text-slate-900 dark:text-dk-text truncate">
                                                {client} · {mName}
                                            </h4>
                                            <span className="text-[10px] text-slate-400 dark:text-dk-muted font-medium">
                                                ({ev.chaineId})
                                            </span>
                                        </div>
                                    ...
                                    <div className="flex items-center gap-2 shrink-0">
                                        <button
                                            ...
                                            className="px-2 py-1 text-[10px] font-medium text-slate-600 dark:text-dk-muted hover:text-slate-900 dark:hover:text-dk-text hover:bg-slate-100 dark:hover:bg-dk-elevated/60 rounded border border-slate-200 dark:border-dk-border transition-all"
                                        >
                                ...
                                {isSelected && (
                                    <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3 pt-3 border-t border-slate-100 dark:border-dk-border animate-[planning-fade-up_120ms_ease-out]">
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        <p className="text-[11px] text-slate-600 dark:text-dk-text-soft mt-2.5 leading-relaxed">
                                                            {prop.description_fr}
                                                        </p>
                                                        {prop.type === 'OVERTIME' && (
                                                            <div className="mt-2 text-[9px] font-mono text-slate-400 dark:text-dk-muted bg-slate-100/50 dark:bg-dk-elevated/30 p-1.5 rounded border border-slate-100 dark:border-dk-border">
                                                                {tx(lang, { fr: 'Calcul:', ar: 'حساب:', en: 'Calculation:', es: 'Cálculo:', pt: 'Cálculo:', tr: 'Hesaplama:' })} {(prop.details as any).formula}
                                                            </div>
                                                        )}
                                                    </div>

                                                    <div className="mt-4 pt-3 border-t border-slate-100 dark:border-dk-border flex items-center justify-between gap-2">
                                                        <span className="text-[11px] font-black text-slate-900 dark:text-dk-text">
