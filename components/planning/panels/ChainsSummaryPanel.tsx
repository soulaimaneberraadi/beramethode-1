...
export default function ChainsSummaryPanel({
    ...
    const effStyle = (eff: number) =>
        eff >= 1.1 ? 'text-emerald-600 dark:text-emerald-400' :
        eff >= 0.9 ? 'text-slate-500 dark:text-dk-muted' :
        eff >= 0.7 ? 'text-amber-600 dark:text-amber-400' :
        'text-red-500';
        ...
        <div className="shrink-0 border-b border-slate-100 dark:border-dk-border">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    {soloChainId && (
                        <span className="ml-2 text-[10px] font-medium text-indigo-500 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 dark:bg-dk-accent/20 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-800 px-2 py-0.5 rounded-full">
                            {soloChainId}
                        </span>
                    )}
                </div>
                        ...
                        return (
                            <button
                                ...
                                className={`shrink-0 flex flex-col justify-center gap-0.5 px-4 py-2 text-left transition-colors min-w-[120px] ${
                                    isSolo
                                        ? 'bg-indigo-50 dark:bg-indigo-900/30 dark:bg-dk-accent/20 dark:bg-indigo-900/20 border-b-2 border-b-indigo-500'
