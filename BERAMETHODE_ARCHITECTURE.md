...
| 0.5. مصادقة محلية ⭐ | Express JWT (بلا Supabase) | **الدخول يخدم بلا سحابة** (الثغرة الحالية!) |
...
> **أولوية:** الطبقة 0.5 (مصادقة محلية) — لأن العطل الحالي كان الدخول يعتمد على Supabase.
...
| مصادقة محلية fallback | 🔨 للتحقّق/البناء |
...
- [ ] **مصادقة محلية fallback** (الدخول يخدم بلا Supabase) — Plan B الأهمّ.
- [ ] طابور offline موثّق.
